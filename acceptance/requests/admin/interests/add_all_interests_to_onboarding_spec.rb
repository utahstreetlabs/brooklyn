...
feature 'Add all interests to onboarding', js: true do
  ...
  scenario 'without selecting any interests' do
    visit admin_interests_path
    add_all_interests_without_selecting_any
    current_path.should == admin_interests_path
    page.should have_no_interests_with_onboarding
  end

  def add_all_interests
    check 'toggle_all'
    click_on 'Add selected to onboarding'
  end

  def add_all_interests_without_selecting_any
    click_on 'Add selected to onboarding'
  end
